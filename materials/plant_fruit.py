...
class PlantFruit(RWMaterial):
	material_name = "Plant Fruit"
	material_description = "A self illuminated static model material with diffuse and normal textures, used for fruits in the game world."
	...
	def get_material_builder(exporter, rw4_material):
		...
		material.set_render_states('PLANT_FRUIT')
	...
	def parse_material_builder(material, rw4_material):
		...
		if material.shader_id != 0x4000000E and material.shader_id != 0x4000000C and material.shader_id != 0x4000000D:
			return False
	...
	def set_texture(obj, material, slot_index, path):
		if slot_index == 0:
			material.rw4.material_data_PlantFruit.diffuse_texture = path
			...
			material.rw4.material_data_PlantFruit.normal_texture = path
