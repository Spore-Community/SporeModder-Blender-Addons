...
out = os.path.join(tempfile.gettempdir(), "out_sym.rw4")
try:
	with open(out, 'wb') as f:
		export_rw4(f, True, False)
except AttributeError:
	traceback.print_exc(); print("EXPORT_SYM_FAIL_ATTRIBUTEERROR"); raise
except Exception:
	traceback.print_exc(); print("EXPORT_SYM_FAIL_OTHER"); raise
assert os.path.getsize(out) > 0, "empty symmetric export"
print("TEST_EXPORT_SYM_OK")
